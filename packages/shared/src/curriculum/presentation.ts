...
const BAND_PEDAGOGY_BASE: readonly BandPedagogyBase[] = [
  ...
  },
  {
    ...
    wordPatternLabels: ["-tion and -sion -> -ción and -sión", "ph -> f for common words"],
  ...
  },
  {
    ...
    vocabularyFocus: "routine contexts, schedules, movement, locations, errands",
    wordPatternLabels: ["routine context words when the local context is clear"],
    phraseFocusExamples: ["every day -> todos los días", "next week -> la próxima semana"],
  ...
  },
  {
    ...
    phraseFocusExamples: ["more than -> más que", "a few -> unos pocos", "the same as -> lo mismo que"],
  ...
  },
  {
    ...
    vocabularyFocus: "ongoing activity, movement/change, situations, descriptive language",
  ...
  },
  {
    ...
    phraseFocusExamples: ["because of -> debido a", "after that -> después de eso"],
  ...
  },
  {
    ...
    wordPatternLabels: ["shared academic word families when safe"],
  ...
  },
  {
    ...
    wordPatternLabels: ["abstract nouns and process vocabulary in context"],
  ...
  },
  {
    ...
    phraseFocusExamples: ["in terms of -> en términos de", "with respect to -> con respecto a"],
